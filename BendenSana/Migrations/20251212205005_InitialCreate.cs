        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HexCode = table.Column<string>(type: "TEXT", maxLength: 10, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Coupons_DiscountType", "DiscountType IN ('percentage','fixed')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AddressLine = table.Column<string>(type: "TEXT", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    TradeCode = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    OffererId = table.Column<string>(type: "TEXT", nullable: false),
                    ReceiverId = table.Column<string>(type: "TEXT", nullable: false),
                    Status = table.Column<string>(type: "TEXT", nullable: false),
                    OffererMessage = table.Column<string>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TradeOffers_Status", "Status IN ('pending','accepted','rejected','cancelled')");
                    table.ForeignKey(
                        name: "FK_Trade_Offers_AspNetUsers_OffererId",
                        column: x => x.OffererId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Trade_Offers_AspNetUsers_ReceiverId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpiryDate = table.Column<string>(type: "TEXT", maxLength: 5, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Gender", "Gender IN ('Male','Female','Unisex','Kids')");
                    table.CheckConstraint("CK_Products_Status", "Status IN ('draft','published','sold','blocked')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Orders_PaymentMethod", "PaymentMethod IN ('bank_transfer','cash_on_delivery','credit_card')");
                    table.CheckConstraint("CK_Orders_Status", "Status IN ('preparing','shipped','delivered','cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Product_Reports_AspNetUsers_ReporterId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_TradeItems_ItemType", "ItemType IN ('offered','requested')");
                    table.ForeignKey(
                        name: "FK_Trade_Items_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Trade_Items_Trade_Offers_TradeId",
                        column: x => x.TradeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Order_Items_AspNetUsers_SellerId",
                        column: x => x.SellerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_Reports_ReporterId",
                table: "Product_Reports",
                column: "ReporterId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Trade_Offers_OffererId",
                table: "Trade_Offers",
                column: "OffererId");

            migrationBuilder.CreateIndex(
                name: "IX_Trade_Offers_ReceiverId",
                table: "Trade_Offers",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_Trade_Offers_TradeCode",
                table: "Trade_Offers",
                column: "TradeCode",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_User_Cards_UserId",
                table: "User_Cards",
                column: "UserId");
        }
